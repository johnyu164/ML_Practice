...
def get_kmax_text_cnn(nb_words, embedding_dim, embedding_matrix, max_sequence_length, out_size):
    ...
    merged_tensor = Concatenate(axis=1)([maxpool_0, maxpool_1, maxpool_2, maxpool_3])
...
def get_av_rnn(nb_words, embedding_dim, embedding_matrix, max_sequence_length, out_size, trainable):
    recurrent_units = 60
    input_layer = Input(shape=(max_sequence_length,))
    embedding_layer = Embedding(nb_words,
                                embedding_dim,
...
def get_dropout_bi_gru(nb_words, embedding_dim, embedding_matrix, max_sequence_length, out_size, trainable):
    recurrent_units = 64
    input_layer = Input(shape=(max_sequence_length,))
    embedding_layer = Embedding(nb_words,
                                embedding_dim,
